...
<div style="display:flex;gap:3px;background:rgba(0,0,0,.4);border-radius:12px;padding:4px;
  ...
  <a href="?tab=signage"
     style="padding:9px 22px;border-radius:9px;font-size:13px;font-weight:700;
            ...
            <?= $tab==='signage'
              ? 'background:rgba(26,122,196,.18);color:#1a7ac4;box-shadow:0 2px 8px rgba(26,122,196,.15);'
              : 'color:#64748b;' ?>">
...
<div style="display:grid;grid-template-columns:repeat(4,1fr);gap:10px;margin-bottom:20px;">
  <?php foreach([
    ['کل', count($filtered), 'fa-tv', '#1a7ac4'],
...
<div style="margin-bottom:20px;">
  <div style="display:flex;align-items:center;gap:10px;margin-bottom:12px;padding-bottom:8px;border-bottom:1px solid rgba(255,255,255,.05);">
    <div style="width:12px;height:12px;border-radius:3px;flex-shrink:0;background:<?=e($group['color']??'#1a7ac4')?>"></div>
...
<div style="text-align:center;padding:70px 20px;color:#475569;">
  <i class="fas <?=$tab==='iptv'?'fa-satellite-dish':'fa-tv'?>"
     style="font-size:52px;display:block;margin-bottom:16px;opacity:.12;color:<?=$tab==='iptv'?'#ef4444':'#1a7ac4'?>;"></i>
  ...
  <div class="modal" style="max-width:500px;">
    ...
    <div style="margin-bottom:16px;border:1px solid rgba(255,255,255,.07);border-radius:10px;overflow:hidden;">
      ...
      <div style="display:flex;align-items:center;gap:10px;padding:10px 14px;border-bottom:1px solid rgba(255,255,255,.04);">
        <div style="width:14px;height:14px;border-radius:3px;flex-shrink:0;background:<?=e($g['color']??'#1a7ac4')?>"></div>
        ...
        <span style="font-size:10px;font-weight:700;padding:2px 8px;border-radius:10px;
          <?=($g['type']??'')==='iptv'
            ...
            :'background:rgba(26,122,196,.1);color:#1a7ac4;border:1px solid rgba(26,122,196,.3);'?>">
    ...
    <form method="POST" action="/admin/screens/groups" class="space-y-3"
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;">
        ...
        <div>
          ...
          <input type="color" name="color" class="form-input" value="#1a7ac4"
                 style="height:42px;padding:4px;cursor:pointer;">
        </div>
      </div>
      <button type="submit"
        style="width:100%;padding:11px;background:linear-gradient(135deg,#1a7ac4,#12558f);
...
<div style="background:#16161f;border:1px solid rgba(255,255,255,.07);border-radius:12px;
     ...
     onmouseenter="this.style.borderColor='rgba(26,122,196,.3)'"
...
HTML;
    if ($online) {
        ...
        echo "<div style='text-align:center;'>
          <i class='fas {$ico}' style='font-size:22px;color:#1a7ac4;display:block;margin-bottom:3px;'></i>
  ...
  <div style="padding:11px 12px;">
    ...
    <div style="display:flex;gap:4px;">
      <a href="/admin/screens/{$id}" style="flex:1;text-align:center;padding:6px;
         background:rgba(26,122,196,.08);border:1px solid rgba(26,122,196,.2);
         border-radius:8px;color:#1a7ac4;font-size:11px;font-weight:600;text-decoration:none;">

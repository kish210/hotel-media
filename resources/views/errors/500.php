<?php /* صفحه‌ی ۵۰۰ — مستقل از layout چون ممکن است خطا پیش از
...
<style>
  ...
  .err-code { font-size: 64px; font-weight: 700; color: var(--error); line-height: 1; letter-spacing: -.03em; }
...
<div class="err-box">
  ...
  <div class="err-code">۵۰۰</div>
  <div class="err-title">خطای داخلی سرور</div>
  <div class="err-text">مشکلی در پردازش این درخواست پیش آمد. اگر تکرار شد، گزارش خطا را در <code>storage/logs</code> ببینید.</div>

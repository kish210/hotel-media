...
### 📺 دیجیتال ساینیج — محیط عمومی هتل

| امکان | توضیح |
|-------|-------|
| 📍 **محل‌ها** | لابی، رستوران، سالن کنفرانس، استخر — صفحه می‌داند کجا نصب شده |
| 🗓️ **تابلوی رویداد سالن** | یک پلی‌لیست روی همه‌ی درها؛ هر صفحه برنامه‌ی سالن خودش را نشان می‌دهد |
| 🍽️ **منوی تصویری روی signage** | صفحه‌ی رستوران خودکار منوی همان رستوران را می‌آورد |
| 📰 **محتوای اتاق روی صفحه عمومی** | اخبار، دفترچه تلفن و نوار زنده روی صفحه‌های لابی هم کار می‌کنند |

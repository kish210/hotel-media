...
Write-Host "    2. Windows: روی SETUP-NO-DOCKER.bat دابل‌کلیک کنید (یا install.ps1)" -ForegroundColor Gray
Write-Host "    3. Linux:   bash install.sh"        -ForegroundColor Gray
Write-Host ""
